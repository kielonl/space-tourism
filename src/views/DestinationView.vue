...
const destinationInfo: Destination = {
  moon: {
    name: "moon",
    image: "https://diedieve.sirv.com/Images/image-moon.png",
    bodyText:
  ...
  mars: {
    name: "mars",
    image: "https://diedieve.sirv.com/Images/image-mars.png",
    bodyText:
  ...
  europa: {
    name: "europa",
    image: "https://diedieve.sirv.com/Images/image-europa.png",
    bodyText:
  ...
  titan: {
    name: "titan",
    image: "https://diedieve.sirv.com/Images/image-titan.png",
    bodyText:
...
#destination {
  background: url("https://diedieve.sirv.com/Images/background-destination-desktop.jpg")
...
@media (max-width: 768px) {
  #destination {
    background: url("https://diedieve.sirv.com/Images/background-destination-tablet.jpg")
      no-repeat center center fixed;
    height: fit-content;
    overflow-y: scroll;
...
@media (max-width: 375px) {
  #destination {
    background: url("https://diedieve.sirv.com/Images/background-destination-mobile.jpg")
      no-repeat center center fixed;
    .destination-wrapper {
      .destination-body {
        .left-side {
